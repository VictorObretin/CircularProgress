...
class MainViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func populateControllersArray() {
        ...
        controller = storyboard!.instantiateViewController(withIdentifier: "CircularProgressGroup") as! PageItemViewController
        controller.itemIndex = 1
        controller.view.backgroundColor = UIColor.clear
        _controllers.append(controller)
        
        controller = storyboard!.instantiateViewController(withIdentifier: "CircularProgressWithLabel") as! PageItemViewController
        controller.itemIndex = 2
        controller.view.backgroundColor = UIColor.clear
        _controllers.append(controller)
        
        controller = storyboard!.instantiateViewController(withIdentifier: "SimpleCircularProgress") as! PageItemViewController
